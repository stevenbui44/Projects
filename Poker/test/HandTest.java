...
public class HandTest {
    ...
    public void testIsStraight() {
        Card[] cards = {new Card(2,'c'), new Card(4,'d'), new Card(5,'s'), new Card(7,'c'), 
                        new Card(8,'c')};
    ...
    public void testIsStraightFlush() {
        Card[] cards = {new Card(3,'c'), new Card(4,'c'), new Card(5,'c'), new Card(6,'c'), 
                        new Card(7,'c')};
    ...
    public void testHasFourOfAKind() {
        Card[] cards = {new Card(4,'c'), new Card(4,'d'), new Card(4,'s'), new Card(4,'h'), 
                        new Card(7,'c')};
    ...
    public void testHasThreeOfAKind() {
        Card[] cards = {new Card(4,'c'), new Card(4,'d'), new Card(4,'s'), new Card(6,'c'), 
                        new Card(7,'c')};
    ...
    public void testHasTwoPairs() {
        Card[] cards = {new Card(4,'c'), new Card(4,'d'), new Card(6,'s'), new Card(6,'c'), 
                        new Card(7,'c')};
    ...
    public void testHasOnePair() {
        Card[] cards = {new Card(4,'c'), new Card(4,'d'), new Card(5,'s'), new Card(6,'c'), 
                        new Card(7,'c')};
